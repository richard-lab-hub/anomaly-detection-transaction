...
from config import base_parser, get_paths, numerical_features, categorical_features
...
# python test.py --data_dir /path --model xgboost --explain
# python test.py --data_dir /path --model xgboost --explain --n_global 5000 --output_dir /path/plots
