...
from config import selected_features, numerical_features, categorical_features
from preprocessing import apply_log_transforms
from shap_utils import _fraud_shap

# ColumnTransformer output order: numerical first, then categorical (matches preprocessing.py)
FEATURE_NAMES = numerical_features + categorical_features

# python predict.py --model_path /mnt/c/Users/richa/Desktop/AI_Credit_Project/IEEEAICreditRiskProject/fraud_pipeline_xgboost.pkl --input /mnt/c/Users/richa/Desktop/AI_Credit_Project/IEEEAICreditRiskProject/new_transactions.csv --output /mnt/c/Users/richa/Desktop/AI_Credit_Project/IEEEAICreditRiskProject/predictions.csv --n_explain 5 --explain
...
def run_shap_local(pipeline, X, flagged_idx, n_explain, output_dir, model_name):
    ...
    # Transform only the rows we need to explain
...
def predict(input_csv, output_csv, model_path, threshold=None, model_name='',
    ...
    if explain:
        ...
        if len(flagged_idx) == 0:
            ...
            # Save SHAP plots in a sibling folder next to the output CSV
...
if __name__ == '__main__':
    args       = parse_args()
    # Derive model name from the filename (e.g. fraud_pipeline_xgboost.pkl → xgboost)
