...
from config import base_parser, get_paths
from models import get_model_and_grid
from preprocessing import apply_log_transforms, build_preprocessor, split_and_save
...
def train(paths, model_name, fast_mode=False):
    ...
    # Apply best params and fit final model once
